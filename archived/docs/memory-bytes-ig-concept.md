# (Archived) Memory Bytes — Monet × Renoir × Instagram concept

> Archived 2026-06-23. The "memory bytes" + Renoir + Instagram framing (old PERSONA.md).
> Out of scope under the whiteroom re-scope (docs/015) — Renoir is a v2 idea, IG is parked.
> Kept for reference. Note: the *clean-slate but accumulating memory* idea below lives on in the whiteroom.
